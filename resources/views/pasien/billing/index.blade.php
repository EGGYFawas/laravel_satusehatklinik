    ...
    <div class="w-full max-w-lg mx-auto pb-20">
                    ...
                    <div class="mt-4 space-y-2">
                        ...
                        @else
                            ...
                            <a href="{{ route('pasien.billing.pay', $bill->id) }}" 
                               class="block w-full text-center bg-teal-600 hover:bg-teal-700 text-white font-bold py-3 px-4 rounded-lg shadow-md transition transform hover:scale-[1.02]">
        ...
        @empty
            <div class="flex flex-col items-center justify-center py-12 text-gray-400 bg-white rounded-xl shadow-sm border border-dashed border-gray-200">
                ...
                <p>Belum ada tagihan obat hari ini.</p>
            </div>
        @endforelse
    </div>
@endsection