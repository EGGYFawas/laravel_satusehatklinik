...
<body class="font-poppins bg-brand-background text-text-dark antialiased">
    ...
    <header class="fixed top-0 left-0 right-0 bg-white backdrop-blur-md shadow-sm z-50">
    ...
    <footer class="bg-gray-900 text-gray-300 py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                ...
                <div>
                    <div class="flex items-center gap-2 mb-4">
                        ...
                        <span class="font-bold text-white text-lg">Klinik Satu Sehat</span>
                    </div>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm">
                        {{-- [MODIFIKASI] Link diubah agar berfungsi di semua halaman --}}
                        ...
                        <li><a href="{{ route('landing') }}#tentang" class="text-gray-400 hover:text-blue-400 transition">Tentang Kami</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm">
                        {{-- [PENAMBAHAN BARU] Link Login / Dashboard --}}
                        @auth
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm">
                        ...
                        <li class="flex items-center gap-2">
                            ...
                            <span class="text-gray-400">info@kliniksahat.id</span>
                        </li>
            ...
            <div class="border-t border-gray-700 pt-8 text-center text-sm text-gray-400">
                <p>&copy; {{ date('Y') }} Klinik Satu Sehat. Hak cipta dilindungi.</p>
            </div>
        </div>
    </footer>
    {{-- [/MODIFIKASI] --}}
