...
<head>
    ...
    <title>@yield('title', $clinicName . ' - Petugas Loket')</title>
        ...
        >
            ...
            <nav class="flex-grow px-4 overflow-y-auto">
                <ul>
                    ...
                    {!! menu_item_petugas('petugas-loket.dashboard', 'Dashboard Apotek', '<svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"></path></svg>') !!}
                    {!! menu_item_petugas('petugas-loket.antrean-offline.index', 'Pendaftaran Walk-in', '<svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>') !!}
                </ul>
            </nav>
            ...
            <header class="bg-[#ABDCD6] shadow-md z-20">
                <div class="flex items-center justify-between p-4 text-slate-800">
                    <div class="flex items-center">
                        ...
                        <h2 class="hidden md:block text-xl font-semibold ml-4">Selamat Bekerja, {{ Auth::user()->full_name ?? 'Petugas' }}</h2>
                    </div>
